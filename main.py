...
class Robot():
	def __init__(self, SM, mot1, mot2, GP = None, US = None, SM_speed = 1500, SM_sleep = 0.2, critical_distance = 10, max_map_size = [10,10], turn_tolerance = 0.05, straight_tolerance = 2, motor_speed = 200, motor_speed_turning = 150):
